  ...
  implements IDex<WombatExchangeData>
{
  ...
  public static dexKeysWithNetwork: { key: string; networks: Network[] }[] =
    getDexKeysWithNetwork(WombatExchangeConfig);
  ...
  async getPricesVolume(
    ...
    blockNumber: number,
    limitPools?: string[],
  ): Promise<null | ExchangePrices<WombatExchangeData>> {
    // TODO: complete me!
    return null;
  }
  ...
  getCalldataGasCost(
    poolPrices: PoolPrices<WombatExchangeData>,
  ): number | number[] {
