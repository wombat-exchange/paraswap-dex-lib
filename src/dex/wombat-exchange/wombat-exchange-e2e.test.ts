...
/*
  ...
  This test script should add e2e tests for WombatExchange. The tests
  ...
  tokenB with any two highly liquid tokens on WombatExchange for the tests
  to work. If the tokens that you would like to use are not defined in
  Tokens or Holders map, you can update the './tests/constants-e2e'

  Other than the standard cases that are already added by the template
  it is highly recommended to add test cases which could be specific
  to testing WombatExchange (Eg. Tests based on poolType, special tokens,
  etc).
...
describe('WombatExchange E2E', () => {
  ...
  describe('Mainnet', () => {
    ...
    // TODO: Add any additional test cases required to test WombatExchange
  });
});
